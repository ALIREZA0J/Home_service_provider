...
class CustomerServiceTest {
    ...
    void givenMethodCalledRegister_whenEveryThingIsOk_thenReturnProperResult() {
        Customer customer = Customer.builder()
                ...
                .setGmail("testCustomer@gmail.com").setPassword("TESTcustomer@#123")
                .build();
    ...
    void givenMethodCalledLogIn_whenEveryThingIsOk_thenReturnProperResult() {
        String gmail = "testCustomer@gmail.com";
        String password = "TESTcustomer@#123";

        Customer customer = customerService.logIn(gmail, password);
    ...
    void givenMethodCalledLogIn_whenGmailIsWrong_thenThrowException() {
        ...
        Assertions.assertThrows(CustomerException.class, () -> customerService.logIn(gmail, password));
    }
